...
public abstract class AbstractMovementDetector implements SensorEventListener {
    ...
    public AbstractMovementDetector(AlarmCallback callback, float sensitivity){
        this.callback = callback;
    ...
    public void onSensorChanged(SensorEvent event) {
        if (event.sensor.getType() == Sensor.TYPE_LINEAR_ACCELERATION || event.sensor.getType() == Sensor.TYPE_ROTATION_VECTOR ) {
